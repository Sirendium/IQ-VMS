...
namespace iSpyApplication
{
    public partial class AddCamera : Form
    {
        ...
        int check;
        public List<Rectangle> _motionZonesRectangles1 = new List<Rectangle>();
        public AddCamera()
        {
            InitializeComponent();
            RenderResources();
        ...
        private void AddCameraLoad(object sender, EventArgs e)
        {
            ...
            ///////////////////////Checking objects////////////////////////////
            StreamReader f2 = new StreamReader("Checking_obj.bysec");
            string result = f2.ReadLine();
            f2.Close();
            if (result == "1")
            {
                ddlAlertMode.SelectedIndex = 5;
            }
            //////////////////////////////////////////////////Finish checking objects////////////
        ...
        private bool Save()
        {
           ...
           // var our_zones = new List<objectsCameraDetectorZone>();
           // our_zones[0] = AreaControl.MotionZones[0];
            

            if (check == 1) { 
            StreamReader f1 = new StreamReader("color_track.txt");
            string result = f1.ReadLine();
            f1.Close();

                //////
                StreamReader f2 = new StreamReader("test.txt");
                string result1 = f2.ReadLine();
                f2.Close();
                /////////////
                CameraControl.Camobject.detector.colourprocessing = result;
        ...
        {
            string color_checking = textBox1.Text;
        ...
        private void gbZones_Enter(object sender, EventArgs e)
        {
        ...
        {
            check = 1;
            Tricko_Setting f = new Tricko_Setting();
            f.Show();
        }
        ...
        private void ranger1_Load(object sender, EventArgs e)
        {
